...
if clientID != -1:
    ...
    if ret1 == 0 and ret2 == 0 and ret3 == 0:
        ...
        for i in range(0, 3):
            ...
            for j in range(0, 5):
                # Generating random positions for the motors 121, 132, 263   121, 132, 204
                awrist = 121#random.randint(0, 300)
                aelbow = 132#random.randint(0, 300)
                ashoulder = 204#random.randint(0, 300)
